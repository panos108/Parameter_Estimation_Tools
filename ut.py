from casadi import *
import numpy as np
from utilities_leeds import objective, objective_pe, collocation, maximum_likelihood_est, construct_polynomials_basis, integrator_model, fim_for_single_t, objective_cov
from pyDOE import *
from GP_ut import *
#from GP_ut_mean import GP_model as GP_t
...
def construct_NLP_RK4(N_exp, f, x_0, x_init, lbx, ubx, lbu, ubu, lbtheta, ubtheta,
                              dt, N, x_meas, theta0, d, ms):
    nx = np.shape(x_init)[1]
    xmin = np.zeros(nx-1)
    xmax = np.zeros(nx-1)#-1)
